...
=======
	return (
		<div>
			...
			<Space direction={"vertical"} size={[10, 150]}>
				<Tag text={"tag"} color={"blue"} />
>>>>>>> ef48825c81a3f084ec9e2be8c6cab7e0a4666db0
